...
class XPlaneSceneSettings(bpy.types.PropertyGroup):
    ...
    collection_sort_order: bpy.props.EnumProperty(
        name="Collection Sort",
        description="Sort exported collections by name",
        items=[
            ('ASC', "A → Z", "Sort collections alphabetically"),
            ('DESC', "Z → A", "Sort collections reverse alphabetically"),
        ],
        default='ASC',
    )

    other_collections_filter: bpy.props.StringProperty(
        name="Filter",
        description="Filter Other Collections by name",
        default="",
    )
...
def register():
    ...
    bpy.types.PoseBone.xplane = bpy.props.PointerProperty(
        type=XPlaneBoneSettings,
        name="X-Plane Bone Settings",
        description="X-Plane Bone Settings",
    )
...
def unregister():
    # Remove attached X-Plane properties
    if hasattr(bpy.types.Collection, "xplane"):
        del bpy.types.Collection.xplane
    if hasattr(bpy.types.Scene, "xplane"):
        del bpy.types.Scene.xplane
    if hasattr(bpy.types.Object, "xplane"):
        del bpy.types.Object.xplane
    if hasattr(bpy.types.Bone, "xplane"):
        del bpy.types.Bone.xplane
    if hasattr(bpy.types.PoseBone, "xplane"):
        del bpy.types.PoseBone.xplane
    if hasattr(bpy.types.Material, "xplane"):
        del bpy.types.Material.xplane
    if hasattr(bpy.types.Light, "xplane"):
        del bpy.types.Light.xplane

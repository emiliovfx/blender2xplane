    ...
    if version >= 1210:
        ...
        if canHaveDraped:
            ...
            if layer_props.file_draped_decal1 and not is_path_decal_lib(layer_props.file_draped_decal1):
                ...
                draped_decal1_column_1.prop(layer_props, "draped_rgb_decal1_green_key",
                                            text="RGB Detail Texture Green Key")
                draped_decal1_column_1.prop(layer_props, "draped_rgb_decal1_blue_key",
                                            text="RGB Detail Texture Blue Key")
                draped_decal1_column_1.prop(layer_props, "draped_rgb_decal1_alpha_key",
                                            text="RGB Detail Texture Alpha Key")
                draped_decal1_column_1.prop(layer_props, "draped_rgb_decal1_modulator",
                                            text="RGB Detail Texture Modulator Strength")
                draped_decal1_column_1.prop(layer_props, "draped_rgb_decal1_constant",
                                            text="RGB Detail Texture Constant Strength")

                draped_decal1_column_2 = draped_decal1_row_2.column()

                draped_decal1_column_2.prop(layer_props, "draped_alpha_decal1_red_key",
                                            text="Alpha Detail Texture Red Key")
                draped_decal1_column_2.prop(layer_props, "draped_alpha_decal1_green_key",
                                            text="Alpha Detail Texture Green Key")
                draped_decal1_column_2.prop(layer_props, "draped_alpha_decal1_blue_key",
                                            text="Alpha Detail Texture Blue Key")
                draped_decal1_column_2.prop(layer_props, "draped_alpha_decal1_alpha_key",
                                            text="Alpha Detail Texture Alpha Key")
                draped_decal1_column_2.prop(layer_props, "draped_alpha_decal1_modulator",
                                            text="Alpha Detail Texture Modulator Strength")
                draped_decal1_column_2.prop(layer_props, "draped_alpha_decal1_constant",
                                            text="Alpha Detail Texture Constant Strength")
            ...
            if layer_props.file_draped_decal2 and not is_path_decal_lib(layer_props.file_draped_decal2):
                ...
                draped_decal2_column_1.prop(layer_props, "draped_rgb_decal2_green_key",
                                            text="RGB Detail Texture Green Key")
                draped_decal2_column_1.prop(layer_props, "draped_rgb_decal2_blue_key",
                                            text="RGB Detail Texture Blue Key")
                draped_decal2_column_1.prop(layer_props, "draped_rgb_decal2_alpha_key",
                                            text="RGB Detail Texture Alpha Key")
                draped_decal2_column_1.prop(layer_props, "draped_rgb_decal2_modulator",
                                            text="RGB Detail Texture Modulator Strength")
                draped_decal2_column_1.prop(layer_props, "draped_rgb_decal2_constant",
                                            text="RGB Detail Texture Constant Strength")

                draped_decal2_column_2 = draped_decal2_row_2.column()

                draped_decal2_column_2.prop(layer_props, "draped_alpha_decal2_red_key",
                                            text="Alpha Detail Texture Red Key")
                draped_decal2_column_2.prop(layer_props, "draped_alpha_decal2_green_key",
                                            text="Alpha Detail Texture Green Key")
                draped_decal2_column_2.prop(layer_props, "draped_alpha_decal2_blue_key",
                                            text="Alpha Detail Texture Blue Key")
                draped_decal2_column_2.prop(layer_props, "draped_alpha_decal2_alpha_key",
                                            text="Alpha Detail Texture Alpha Key")
                draped_decal2_column_2.prop(layer_props, "draped_alpha_decal2_modulator",
                                            text="Alpha Detail Texture Modulator Strength")
                draped_decal2_column_2.prop(layer_props, "draped_alpha_decal2_constant",
                                            text="Alpha Detail Texture Constant Strength")
...
def light_layout(layout: bpy.types.UILayout, obj: bpy.types.Object) -> None:
    ...
    if light_data.xplane.type == LIGHT_AUTOMATIC and light_data.type not in {
                    ...
                    if light_data.type == "POINT":
                        ...
                        if has_width:
                            if is_bb and not is_v12_bb:
                                WIDTH_val = round(
                                    XPlaneLight.WIDTH_for_billboard(
                            ...
                            WIDTH_val = round(
                                XPlaneLight.DIR_MAG_for_billboard(
                                    light_data.spot_size
                                ),
                                5,
                            )
        ...
        if light_data.type == "POINT":
            ...
            WIDTH_val = round(
                XPlaneLight.WIDTH_for_spill(light_data.spot_size), 5
            )
        debug_box.row().label(text=f"Width: {WIDTH_val}")
...
def manipulator_layout(layout: bpy.types.UILayout, obj: bpy.types.Object) -> None:
    ...
    if obj.xplane.manip.enabled:
        ...
        props['dataref1'] = (lambda manip_type: manip_type in MANIPULATORS_ALL - MANIPULATORS_COMMAND - {MANIP_NOOP} and \
                             ...
                             lambda manip_type: get_dataref_title(manip_type, 1))
        props['dataref2'] = \
            lambda manip_type: manip_type in {MANIP_DRAG_XY} | {MANIP_DRAG_AXIS_DETENT,
                                                                MANIP_DRAG_ROTATE_DETENT} and should_show_dataref(
                manip_type), \
        ...
        props['v1'] = (lambda manip_type: manip_type in {MANIP_DRAG_AXIS, MANIP_DRAG_AXIS_PIX, MANIP_AXIS_KNOB,
                                                         MANIP_AXIS_SWITCH_UP_DOWN, MANIP_AXIS_SWITCH_LEFT_RIGHT}, None)
        props['v2'] = (lambda manip_type: manip_type in {MANIP_DRAG_AXIS, MANIP_DRAG_AXIS_PIX, MANIP_AXIS_KNOB,
                                                         MANIP_AXIS_SWITCH_UP_DOWN, MANIP_AXIS_SWITCH_LEFT_RIGHT}, None)

        props['command'] = (lambda manip_type: manip_type in MANIPULATORS_COMMAND_1110 | {MANIP_COMMAND}, None)
        props['positive_command'] = (lambda manip_type: manip_type in MANIPULATORS_COMMAND_CLASSIC - {MANIP_COMMAND},
                                     None)
        props['negative_command'] = (lambda manip_type: manip_type in MANIPULATORS_COMMAND_CLASSIC - {MANIP_COMMAND},
                                     None)
        ...
        props['click_step'] = (
            lambda manip_type: manip_type in {MANIP_AXIS_KNOB, MANIP_AXIS_SWITCH_UP_DOWN, MANIP_AXIS_SWITCH_LEFT_RIGHT},
            None)
        props['hold_step'] = (
            lambda manip_type: manip_type in {MANIP_AXIS_KNOB, MANIP_AXIS_SWITCH_UP_DOWN, MANIP_AXIS_SWITCH_LEFT_RIGHT},
            None)
